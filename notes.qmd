...
**If you already have RStudio connected to GitHub, skip this step!**\
\
[**Step 1.1**]{.underline}**: [Sign up for a GitHub account](https://github.com/signup)**

-   I’d recommend using your personal email, not a student email.

[**Step 1.2:**]{.underline} **Install Git**
...
[**Step 1.3:**]{.underline} **Configure Git in R**
...
[**Step 1.4**]{.underline}**: Configure Your Personal Access Token (PAT)**
...
![](https://docs.catalyst.zoho.com/images/tutorials/githubbot/github-bot-generate-personal-access-token.webp)
...
If you'd like to see how THIS exact website was built, check out <https://github.com/grcetmpk/rladies-quartowebpages>.

One thing I've been playing around a lot with recently is tracking **website usage**. I've created a simple template repository that allows users to opt in and out to cookie tracking via a pop up (which links to a privacy policy).

You can check it out (and use!) the template here: <https://github.com/grcetmpk/quarto-website-template>.
...
An example of a Quarto slide deck can be found [here](https://ubc-dsci.github.io/dsci-100-slides/slides_source/04_viz.html#/title-slide). These are pretty fancy - you can take notes and code directly in them using `webr`!
